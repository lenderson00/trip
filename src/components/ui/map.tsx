...
function Map({
    ...
    return (
        <LeafletMapContainer
            ...
            zoomControl={false}
            className={cn(
                "z-10 size-full min-h-64 flex-1 rounded-sm",
                className
            )}
            {...props}
        />
...
function MapPopup({
    ...
    return (
        <LeafletPopup
            className={cn(
                "z-50 w-56 rounded-sm border border-ink/10 bg-paper-cream p-3 font-body text-ink shadow-[var(--shadow-lift)] outline-hidden",
                className
            )}
            {...props}
        />
        ...
        <MapControlContainer className={cn(position, className)}>
            <ButtonGroup
                ...
                <Button
                    ...
                    aria-label="Zoom in"
                    title="Zoom in"
                    className="border border-ink/15 bg-paper-cream text-ink hover:bg-paper-white"
