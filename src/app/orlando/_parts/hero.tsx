...
export function Hero() {
  return (
    <header className="relative mb-16 pt-6">
      {/* Rota do voo, saindo de cima pra esquerda. */}
      <DashedPath
        width={300}
        height={120}
        curve={64}
      ...
      {/* Colagem: fluxo no mobile, sobreposta no desktop. */}
      <div className="relative mt-10 flex flex-wrap items-center justify-center gap-6 lg:mt-4 lg:block lg:h-[420px]">
        <LightLeak
          seed="capa"
          intensity={0.7}
        ...
        >
          <PhotoFrame
            ...
            alt="Castelo iluminado com fogos ao anoitecer"
            width={330}
            ratio={1.34}
            rotate={-2}
          >
        ...
        <TornCircle
          ...
          alt="Piscina do resort com palmeiras"
          size={124}
          seed="c2"
          rotate={9}
